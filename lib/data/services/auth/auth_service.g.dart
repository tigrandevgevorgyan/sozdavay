...
class _AuthService implements AuthService {
  ...
  @override
  Future<IsCompletedResponse> auth(String phone) async {
  ...
  @override
  Future<AccessTokenResponse> authConfirm(
    String phone,
    String code,
    String osType,
    String appVersion,
  ...
  @override
  Future<IsCompletedResponse> logout() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<RegisterOptionsResponse> registerOptions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RegisterOptionsResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RegisterOptionsResponse _value;
    try {
      _value = RegisterOptionsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
